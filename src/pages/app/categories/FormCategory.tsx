'use client'
import { Button, ColorPicker, Drawer, Form, Input, InputNumber, Select } from "antd"
import { useCategoriesPageContext } from "./contexts/CategoriesPageContext";
import CustomizeRequiredMark from "@/src/components/customs/required-mark";
...
export default function FormCategory({
    ...
    const { isOpenForm, closeForm } = useCategoriesPageContext();
        ...
        >
            ...
            >
                ...
                <div className="relative flex gap-4">
                    ...
                    <Form.Item label="Emoji" className="flex-1" required name={'emoji'}>
                        <Select
                            className="!w-full"
                ...
                <Form.Item className="flex-1" >
                    <Button className="!w-full" type="primary" htmlType="submit">Guardar</Button>
                </Form.Item>
            </Form>
        </Drawer>
    )
